...
def video():
    return Response(
        generate_frames(path_x="./data/vid1.mp4"),
...
def stream():
    return Response(
        generate_frames(
            path_x="http://192.168.100.252:8989/get-stream/ZGV2LXJhcHRvci1haQ--/cnRzcDovL3JhcHRvcjpSYXB0b3IxMjMhQDE5Mi4xNjguMTAwLjM2OjU1NC9jYW0vcmVhbG1vbml0b3I_Y2hhbm5lbD0xJnN1YnR5cGU9MCZ1bmljYXN0PXRydWUmcHJvdG89T252aWY-"
        ),
        mimetype="multipart/x-mixed-replace; boundary=frame",
    )
